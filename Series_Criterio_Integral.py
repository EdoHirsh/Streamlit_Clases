...
def Draw_Criterio(n ,N, PuntosSubintervalos, intervalo_x_vent = [-0.5,10.5], intervalo_y_vent = [-0.075,1.075], intervalo_x_graf = [0,10.5], SumaSuperior = True, SumaInferior = True, mostrar_funcion = True, Mostrar_integral = False):
    ...
    if mostrar_funcion:
        ...
        ax.text(intervalo_x_graf[1],func_f(intervalo_x_graf[1])-0.01,r'$f(x)$', fontsize=Tam_fuentes, color='black', verticalalignment='top', horizontalalignment='right')
    ...
    if Mostrar_integral:
        ...
        ax.text(intervalo_x_graf[1],func_f(intervalo_x_graf[1])+0.04,r'$\int_{1}^{10} f(x) dx$', fontsize=Tam_fuentes, color='black', verticalalignment='bottom', horizontalalignment='right')
