...
def main():
    ...
    st.set_page_config(page_title="Serie de Taylor de la función cos(x)", layout="wide", initial_sidebar_state='expanded', page_icon=':material/line_axis:')

    #! Titulo
    st.title('Serie de Taylor de la función $\cos(x)$')
